...
var DepositRewards = function (_a) {
    ...
    var handleDepositRewards = function () { return __awaiter(void 0, void 0, void 0, function () {
        var program, tokenMintAddress, owner, mintInfo, decimals, decimalsAmount, rewardTokenAccount, _a, vaultTokenAccount, _bump2, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, spl_token_1.getMint)(provider.connection, new web3_js_1.PublicKey(tokenMint))];
                case 1:
                    mintInfo = _b.sent();
                    decimals = mintInfo.decimals;
                    decimalsAmount = amount * Math.pow(10, decimals);
                    return [4 /*yield*/, (0, spl_token_1.getAssociatedTokenAddress)(tokenMintAddress, provider.wallet.publicKey)];
                case 2:
                    rewardTokenAccount = _b.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, program.methods.addRewards(new anchor_1.BN(decimalsAmount))
                            .accounts({
                            vault: vault,
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error("Error depositing rewards:", error_1);
                    return [3 /*break*/, 6];
                case 6: return [2 /*return*/];
            }
        });
    }); };
    return (react_1.default.createElement("div", { className: "depositRewardsContainer" },
        react_1.default.createElement("h1", null, "Add Rewards"),
        ...
        react_1.default.createElement("input", { type: "number", placeholder: "Amount to Deposit", value: amount, onChange: function (e) { return setAmount(Number(e.target.value)); } }),
        react_1.default.createElement("button", { className: "depositButton", onClick: handleDepositRewards }, "Deposit Rewards")));
};
exports.DepositRewards = DepositRewards;
